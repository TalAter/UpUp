...
var _CACHE_NAME="upup-cache";self.addEventListener("message",function(a){"set-settings"===a.data.action&&_setSettings(a.data.settings)}),self.addEventListener("fetch",function(a){a.respondWith(fetch(a.request.url)["catch"](function(){return caches.match("sw-offline-content")}))});var _setSettings=function(a){return caches.open(_CACHE_NAME).then(function(b){return a.content?b.put("sw-offline-content",new Response(a.content)):b.put("sw-offline-content",new Response("You are offline"))})};
