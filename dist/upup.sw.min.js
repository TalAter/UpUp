...
var _CACHE_NAME="upup-cache";self.addEventListener("message",function(a){"set-settings"===a.data.action&&_setSettings(a.data.settings)}),self.addEventListener("fetch",function(a){a.respondWith(fetch(a.request.url)["catch"](function(){return caches.match(a.request).then(function(a){return a||caches.match("sw-offline-content")})}))});var _setSettings=function(a){return caches.open(_CACHE_NAME).then(function(b){return a.assets&&b.addAll(a.assets.map(function(a){return new Request(a,{mode:"no-cors"})})),a["content-url"]?fetch(a["content-url"]).then(function(a){return b.put("sw-offline-content",a)}):a.content?b.put("sw-offline-content",_buildResponse(a.content)):b.put("sw-offline-content",_buildResponse("You are offline"))})},_buildResponse=function(a){return new Response(a,{headers:{"Content-Type":"text/html"}})};
